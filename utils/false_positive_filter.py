...
class FalsePositiveFilter:
    ...
    def __init__(self):
        ...
        self.false_positive_patterns = {
            ...
            'wordpress_on_non_wp': {
                ...
                'indicators': ['juice', 'dvwa', 'webgoat']  # If URL contains these, it's not WordPress
            },
    ...
    def filter_findings(self, findings: List, target_url: str = "") -> List:
        ...
        for finding in findings:
            if self._is_false_positive(finding, target_url):
                print(f"  🗑️  Filtered false positive: {finding.vuln_type} at {finding.url}")
                continue
    ...
    def _is_wordpress_false_positive(self, finding, target_url: str) -> bool:
        ...
        non_wp_indicators = self.false_positive_patterns['wordpress_on_non_wp']['indicators']
        ...
        is_non_wp_site = any(indicator in target_url.lower() or indicator in finding.url.lower() 
