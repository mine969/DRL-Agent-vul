...
# This script lives one level below the project root (tests/), so the root
# must be added to sys.path explicitly for the `env.` package import to
# resolve, regardless of the current working directory (the previous
# os.getcwd()-based approach broke if this was invoked from anywhere but
# the project root).
