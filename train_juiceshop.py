...
class JuiceShopTrainer:
    ...
    def __init__(self, model_path="dqn_web_sec_model.pth", verbose=True, auto_resume=True):
        """
        Args:
        ...
        if auto_resume:
            ...
            if latest_ep > 0:
                checkpoint_path = f"checkpoints/juiceshop_8k_ep{latest_ep}.pth"
                try:
    ...
    def _find_latest_checkpoint(self):
        ...
        import glob
        import re
        checkpoints = glob.glob("checkpoints/juiceshop_8k_ep*.pth")
        if not checkpoints:
            return 0
    ...
    def train(self, total_episodes=2000, start_episode=None):
        ...
        try:
            ...
            print(f"✅ Checkpoint saved: checkpoints/juiceshop_8k_ep{current_episode}.pth")
            print(f"\n💡 To resume training, run:")
            print(f"   python train_juiceshop.py --episodes {total_episodes}")
            return
        
        # Final save
        final_checkpoint = f"checkpoints/juiceshop_8k_ep{total_episodes}.pth"
    ...
    def _save_checkpoint(self, episode):
        ...
        checkpoint_path = f"checkpoints/juiceshop_8k_ep{episode}.pth"
...
if __name__ == "__main__":
    ...
    # Start training
    trainer = JuiceShopTrainer(model_path=args.model, verbose=args.verbose)
