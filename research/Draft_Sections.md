...
Table I reports the average confirmed findings across five independent evaluation runs for each vulnerable application and vulnerability class. Only the averaged detection counts and averaged detection rates are included in the table, spanning High/Critical threats like SQL Injection, Command Injection, and Broken Access Control, as well as Medium severity flaws like IDOR and CSRF.

| Website             | Vulnerability Type                      | Total Existing | Detected by Agent | Detection Rate | Severity |
| ------------------- | --------------------------------------- | -------------: | ----------------: | -------------: | -------- |
| E-Commerce (5002)   | SQL Injection                           |              3 |                 1 |          33.3% | Critical |
| E-Commerce (5002)   | Cross-Site Scripting (XSS)              |              2 |                 0 |           0.0% | High     |
| E-Commerce (5002)   | Insecure Direct Object Reference (IDOR) |              4 |                 0 |           0.0% | Medium   |
| E-Commerce (5002)   | Broken Access Control (BAC)             |              1 |                 0 |           0.0% | High     |
| E-Commerce (5002)   | Mass Assignment                         |              1 |                 0 |           0.0% | High     |
| E-Commerce (5002)   | Business Logic                          |              3 |                 0 |           0.0% | Medium   |
| E-Commerce (5002)   | Race Condition                          |              2 |                 0 |           0.0% | Medium   |
| E-Commerce (5002)   | Insecure Deserialization                |              1 |                 0 |           0.0% | Critical |
| E-Commerce (5002)   | JWT Bypass                              |              2 |                 0 |           0.0% | High     |
| E-Commerce (5002)   | SAML Bypass                             |              2 |                 0 |           0.0% | High     |
| E-Commerce (5002)   | Information Disclosure                  |              1 |                 0 |           0.0% | High     |
| Social Media (5003) | SQL Injection                           |              2 |                 0 |           0.0% | Critical |
| Social Media (5003) | Cross-Site Scripting (XSS)              |              3 |                 0 |           0.0% | High     |
| Social Media (5003) | Insecure Direct Object Reference (IDOR) |              6 |                 0 |           0.0% | Medium   |
| Social Media (5003) | Cross-Site Request Forgery (CSRF)       |              1 |                 0 |           0.0% | Medium   |
| Social Media (5003) | Path Traversal                          |              1 |                 0 |           0.0% | High     |
| Social Media (5003) | File Upload                             |              2 |                 0 |           0.0% | Critical |
| Social Media (5003) | Weak Password                           |              1 |                 0 |           0.0% | High     |
| Social Media (5003) | Session Fixation                        |              1 |                 0 |           0.0% | High     |
| Social Media (5003) | Weak Reset Token                        |              1 |                 0 |           0.0% | High     |
| Social Media (5003) | OAuth Bypass                            |              3 |                 0 |           0.0% | High     |
| Banking (5004)      | Cross-Site Scripting (XSS)              |              1 |                 0 |           0.0% | High     |
| Banking (5004)      | Insecure Direct Object Reference (IDOR) |              2 |                 0 |           0.0% | Medium   |
| Banking (5004)      | Cross-Site Request Forgery (CSRF)       |              1 |                 0 |           0.0% | Medium   |
| Blog (5005)         | SQL Injection                           |              1 |                 0 |           0.0% | Critical |
| Blog (5005)         | Cross-Site Scripting (XSS)              |              4 |                 0 |           0.0% | High     |
| Blog (5005)         | Broken Access Control (BAC)             |              1 |                 0 |           0.0% | High     |
| Blog (5005)         | Server-Side Request Forgery (SSRF)      |              1 |                 0 |           0.0% | High     |
| Blog (5005)         | JWT Bypass                              |              2 |                 0 |           0.0% | High     |
| File Share (5006)   | Cross-Site Scripting (XSS)              |              1 |                 0 |           0.0% | High     |
| File Share (5006)   | Insecure Direct Object Reference (IDOR) |              2 |                 0 |           0.0% | Medium   |
| File Share (5006)   | Path Traversal                          |              1 |                 0 |           0.0% | High     |
| File Share (5006)   | File Upload                             |              1 |                 0 |           0.0% | Critical |
| File Share (5006)   | Command Injection                       |              1 |                 0 |           0.0% | Critical |

As observed in the five-run averages in Table I, the selected `improved_mock_ep10000.pth` checkpoint demonstrates very limited but repeatable detection on this benchmark. Across the averaged runs, the agent consistently identified only one of the three SQL Injection cases in the E-Commerce target, while the remaining vulnerability classes stayed at or near zero detection.
