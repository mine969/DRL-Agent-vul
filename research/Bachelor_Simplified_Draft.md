...
The vulnerability scanner uses a clear, modular design to separate the AI's "brain" from the actual web request engine. The system is built around three main parts:
