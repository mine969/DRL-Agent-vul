...
def find_latest_checkpoint():
    ...
    if not all_checkpoints: return None, 0
    checkpoint_episodes = []
    ...
    if not checkpoint_episodes: return None, 0
...
for episode in range(start_episode, start_episode + 5):
    ...
    print(f"\n🏁 Finished Episode {episode} | Total Reward: {total_reward:6.1f} | Steps: {steps}", flush=True)
